...
@section('content')
    <h1 class="text-2xl font-bold mb-6">Tambah Barang Saya</h1>

    <div class="bg-white rounded shadow p-6 max-w-lg">
        <form method="POST" action="/mahasiswa/barang-saya">
            @csrf

            <div class="mb-4">
                <label for="nama_objek" class="block text-sm font-medium text-gray-700 mb-1">Nama Barang</label>
                <input type="text" name="nama_objek" id="nama_objek" value="{{ old('nama_objek') }}"
